...
@router.get("/", response_model=list[TodoResponse], response_model_by_alias=False)
...
@router.patch("/{todo_id}", response_model=TodoResponse, response_model_by_alias=False)
